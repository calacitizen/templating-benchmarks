...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache034323546453379095 = { loop: _ctx.loop, color: _ctx.color, __k: _ctx.__k };
...
_output += "</li>\n    ";
  ...
  _ctx.loop = _ctx__loopcache034323546453379095.loop;
  _ctx.color = _ctx__loopcache034323546453379095.color;
  _ctx.__k = _ctx__loopcache034323546453379095.__k;
  _ctx__loopcache034323546453379095 = undefined;
})();
_output += "\n</ul>\n";
} else {
_output += "\n<div>\n    No colors!\n</div>\n";
